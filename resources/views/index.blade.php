        ...
        <div class="container-fluid min-vh-100 d-flex flex-column justify-content-center align-items-center bg-light">
            ...
            <div class="row justify-content-center w-100">
                <div class="col-md-6 col-lg-4">
                    <div class="card border-0 shadow-lg rounded-3 text-center p-5">
                        <div class="card-body">
                            <img src="{{ asset('img/logo transparebte.png') }}" alt="Logo"
                                class="img-fluid mb-4" style="max-height: 120px;">

                            <h2 class="fw-bold text-dark mb-3">¡Bienvenido al Sistema!</h2>
                            <p class="text-muted mb-4">
                                Panel de administración para la gestión de clientes y pedidos.
                            </p>

                            <div class="d-grid gap-2">
                                <a href="{{ route('usuarios.index') }}" class="btn btn-success btn-lg">
                                    <i class="fas fa-users me-2"></i> Ir a Clientes
                                </a>
                                <a href="{{ route('venta.index') }}" class="btn btn-primary btn-lg">
                                    <i class="fas fa-cash-register me-2"></i> Ir a Ventas
                                </a>
                            </div>
                        </div>
                    </div>
